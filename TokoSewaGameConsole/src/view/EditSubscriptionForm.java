...
public class EditSubscriptionForm extends javax.swing.JDialog {
    ...
    /**
     * Memuat data subscription ke form
     */
    private void loadSubscriptionData() {
        txtKTP.setText(subscription.getKtp());
        txtKTP.setEditable(false); // KTP tidak bisa diubah karena sebagai primary key
        
        txtNama.setText(subscription.getNama());
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnSimpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 240, 80, -1));
        ...
        jPanel1.add(btnBatal, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 240, 80, -1));
        ...
        if (validateInput()) {
            try {
                ...
                if (subsDAO.updateSubscription(subscription)) {
                    ...
                    JOptionPane.showMessageDialog(this, "Gagal mengupdate data subscription!");
                }
            } catch (ParseException e) {
